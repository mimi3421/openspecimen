...
public class DistributionOrderSearchResultProcessor extends AbstractSearchResultProcessor {
	...
	protected String getQuery() {
		Set<SiteCpPair> siteCps = AccessCtrlMgr.getInstance().getReadAccessDistributionOrderSites();
	...
	private static final String QUERY =
		...
		"  inner join os_orders o on o.identifier = k.entity_id " +
		"  inner join os_distribution_protocol_sites dp_site on dp_site.distribution_protocol_id = o.distribution_protocol_id " +
		"where " +
		"  k.value like ? and " +
		"  k.identifier > ? and " +
		"  k.entity = 'distribution_order' and " +
		"  k.status = 1 and " +
		"  (%s) " +
		"order by " +
		"  k.identifier";
