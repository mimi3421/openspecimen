...
angular.module('os.common.models', [])
  .factory('osModel', function(ApiUrls, $http, $q) {
    function ModelFactory(modelName, initCb) {
      ...
      Model.prototype.$remove = function (forceDelete, reason) {
        var params = {forceDelete: forceDelete, reason: reason};
        return $http.delete(url + this.$id(), {params: params}).then(Model.modelRespTransform);
      };
